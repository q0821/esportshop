...
class plgSocialProfilesHikashop extends SocialProfilePlugin
{
    ...
    protected function getRegistrationForm($profileData)
    {
        ...
        foreach ($profileFields as $profileField)
        {
            ...
            {
                $checkField = $profileField->field_namekey;
            ...
            $html .= '<label title="" class="required" aria-invalid="false" for="' . $profileField->field_namekey . '" id="' . $profileField->field_namekey . '-lbl">';
            $html .= $text . ':';
            ...
            $element = $fieldsClass->display(
                $profileField,
                $fieldValue,
                'data[' . $profileField->field_table . '][' . $profileField->field_namekey . ']',
                false,
                $requiredOption . $onWhat . '="hikashopToggleFields(this.value,\'' . $profileField->field_namekey . '\',\'' . $profileField->field_table . '\',0);"',
                false);
    ...
    protected function createUser($profileData)
    {
        ...
        {
            $profileFieldName = $profileField->field_namekey;
