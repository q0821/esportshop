<?php
/**
* @version		$Id: mod_alphauserpoints_onlineusers.php 2015-08-03 v2.0.2 $
...
class modAlphaUserPointsOnlineUsersHelper {
	...
	public static function getList($params) {
		...
		$query = "SELECT aup.points, u.".$usrname." AS usrname, aup.referreid, u.id AS userid FROM #__alpha_userpoints AS aup, #__users AS u, #__session AS s"
