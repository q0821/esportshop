<?php
/**
* @version		$Id: mod_alphauserpoints_lastestactivity.php 2015-08-03 v2.0.2 $
...
class modAlphaUserPointsLastestActivityHelper {
	...
	public static function getList($params) {
		...
		$query = "SELECT a.insert_date, a.referreid, aup.userid, a.points AS last_points, a.datareference, u.".$usrname." AS usrname, r.rule_name, r.plugin_function, r.category"
			   ...
			   . " WHERE aup.referreid=a.referreid " . $selecteduser . "AND aup.userid=u.id AND aup.published='1' AND a.approved='1' AND (a.expire_date>='".$now."' OR a.expire_date='0000-00-00 00:00:00') AND r.id=a.rule"
			   . $displayactivity
