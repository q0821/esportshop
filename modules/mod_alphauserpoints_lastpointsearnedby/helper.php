<?php
/**
* @version		$Id: mod_alphauserpoints_lastpointsearnedby.php 2015-08-03 v2.0.2 $
...
class modAlphaUserPointsLastPointsEarnedByHelper {
	...
	public static function getList($params) {
		...
		/*$query = "SELECT a.insert_date, a.referreid, a.points AS last_points, u.".$usrname." AS usrname, aup.userid"
			   ...
			   . " WHERE aup.referreid=a.referreid AND aup.userid=u.id AND aup.published='1' AND a.approved='1' AND (a.expire_date>='$now' OR a.expire_date='0000-00-00 00:00:00')"
