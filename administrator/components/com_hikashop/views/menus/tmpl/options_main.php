...
?><div class="hkc-xl-4 hikashop_menu_subblock hikashop_menu_edit_general_part1">
	<div class="hikashop_menu_subblock_content">
		...
		<dl class="hika_options">
			<dt class="hikashop_option_name">
				<label for="data_menu__<?php echo $this->type; ?>_use_menu_name"><?php echo JText::_( 'HIKA_MAIN_CATEGORY' ); ?></label>
			</dt>
			<dd class="hikashop_option_value">
				<?php
		...
		<dl class="hika_options">
			<dt class="hikashop_option_name">
				<label for="data_menu__<?php echo $this->type; ?>_use_menu_name"><?php echo JText::_( 'MENU_NAME_AS_TITLE' ); ?></label>
			</dt>
			<dd class="hikashop_option_value">
				<?php
				if(!isset($this->element['use_menu_name'])) $this->element['use_menu_name'] = '0';
				echo JHTML::_('hikaselect.booleanlist', $this->name.'[use_menu_name]' , '',$this->element['use_menu_name']);
				?>
			</dd>
		</dl>
	</div>
