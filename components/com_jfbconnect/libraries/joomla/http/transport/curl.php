 ...
 *
 *
 * Updated by SourceCoast to add option to disable SSL verification. Too many servers don't have updated root certs
 */
...
{
    class JFBConnectJoomlaHttpTransportCurl extends JHttpTransportCurl
    {
        /**
        ...
        public function request($method, JUri $uri, $data = null, array $headers = null, $timeout = null, $userAgent = null)
        {
            ...
            if (JFBCFactory::config()->get('facebook_curl_disable_ssl', false))
