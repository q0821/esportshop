...
@media (min-width:600px){
	#hikaserial_mail {width:600px !important;margin:auto !important;}
	.pict img {max-width:500px !important;height:auto !important;}
}
@media (max-width:330px){
	#hikaserial_mail{width:300px !important; margin:auto !important;}
...
@media (min-width:331px) and (max-width:480px){
	#hikaserial_mail{width:450px !important; margin:auto !important;}
	table[class=w600], td[class=w600], table[class=w598], td[class=w598], table[class=w500], td[class=w500], img[class="w600"]{width:100% !important;}
...
<div id="hikaserial_mail" style="font-family:Arial, Helvetica,sans-serif;font-size:12px;line-height:18px;width:100%;background-color:#ffffff;padding-bottom:20px;color:#5b5b5b;">
...
<img src="{VAR:LIVE_SITE}/media/com_hikashop/images/icons/icon-48-category.png" border="0" alt="" style="float:left;margin-right:4px;"/>
...
<p>
	...
	{TXT:THE_PACK_LEVEL_IS_LOW_EMAIL_TEXT}
</p>
<p>
	<strong>{VAR:pack_name}</strong>: <a href="{VAR:PACK_URL}">{VAR:current_quantity}</a>
</p>
							</div>
						</td>
						<td class="w20" width="20"></td>
